...
import controller.Cad_pfJdbcDAO;
...
public class PessoaFisica extends JFrame{
	...
	String estado[] = {"AC","AP","BA","DF","GO","MG","PB","PE","RJ","RS","RR","SP"
			,"TO","AL","AM","CE","ES","MA","MS","PA","PR","PI","RN","RO","SC","SE"};
	JComboBox cmbEst = new JComboBox(estado); //aparecer opcoes dos estados
	...
	public PessoaFisica(){
		...
		paine.add(est);
		paine.add(cmbEst);
		cmbEst.setBounds(415, 105, 70, 30);
		...
		btnSalvar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				try {
					...
					Cad_pfJdbcDAO cad_pfJdbcDao = new Cad_pfJdbcDAO(connection);
					
					cad_pfJdbcDao.salvar(pessoaFisica);
	...
	public static void main(String args[]){
		PessoaFisica cad_pf = new PessoaFisica();
		cad_pf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
}